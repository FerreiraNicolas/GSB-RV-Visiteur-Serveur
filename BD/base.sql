...
CREATE TABLE `FicheFrais` (
  ...
  `ff_montanthorsclassif` decimal(5,2) NOT NULL,
  PRIMARY KEY (`ff_mois`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Motif` (
  ...
  `mot_libelle` varchar(25) DEFAULT NULL,
  `mot_precision` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`mot_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Motif` VALUES (1,'Information','none'),(2,'Visite quotidienne','none');
...
INSERT INTO `Offrir` VALUES ('a131',1,'EVILR7',2),('a131',1,'PHYSOI8',5),('a131',6,'EVILR7',2),('a131',6,'PHYSOI8',1),('a131',7,'EVILR7',3),('a131',7,'PHYSOI8',2),('a131',9,'EVILR7',3),('a131',9,'PHYSOI8',2);
...
CREATE TABLE `RapportVisite` (
  ...
  `rap_date_saisie` date NOT NULL DEFAULT,
...
INSERT INTO `RapportVisite` VALUES ('a131',1,'2018-03-01','RAS','2018-03-02',1,22,1),('a131',2,'2018-04-02','RAS','2018-04-03',5,22,2),('a131',3,'2018-04-03','RAS','2018-04-05',0,18,1),('a131',4,'2018-05-10','RAS','2018-05-12',2,22,2),('a131',5,'2018-05-21','RAS','2018-05-25',0,18,1),('a131',7,'2018-01-02','RAS','2018-01-05',2,85,1),('a131',8,'2018-01-09','RAS','2018-01-24',5,85,2),('a131',9,'2018-09-10','RAS','2018-09-15',5,84,1);
...
-- Dump completed on 2019-11-12 16:17:01
